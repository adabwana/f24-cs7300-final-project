...
---
format:
  html: {toc: true, toc-depth: 3, theme: united, number-sections: false, output-file: neandersolve.descriptive.html}
...
```{=html}
<div><pre><small><small>source: <a href="https://github.com/adabwana/f24-cs7300-final-project/blob/master/src/neandersolve/descriptive.clj">src/neandersolve/descriptive.clj</a></small></small></pre></div>
```
