...
---
format:
  html: {toc: true, toc-depth: 3, theme: united, number-sections: false, output-file: neandersolve.pca.html}
...
```{=html}
<div><pre><small><small>source: <a href="https://github.com/adabwana/f24-cs7300-final-project/blob/master/src/neandersolve/pca.clj">src/neandersolve/pca.clj</a></small></small></pre></div>
```
